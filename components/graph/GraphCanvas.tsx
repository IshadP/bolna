    ...
    <div className="relative w-full h-full bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      <div className="absolute top-4 left-5 z-20 flex items-center gap-2">
        ...
        <div className="relative" ref={testDropdownRef}>
          ...
          {isTestDropdownOpen && (
            <div className="absolute left-0 top-full mt-2 w-72 max-h-[80vh] overflow-y-auto rounded-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl p-2 z-50 animate-in fade-in zoom-in-95 duration-150 space-y-1 select-none">
      ...
      {/* Save Success Toast */}
      {saveNotification && (
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 z-30 px-3.5 py-2 rounded-xl bg-slate-900 text-white text-xs font-medium flex items-center gap-2 shadow-xl animate-in fade-in slide-in-from-bottom-2 duration-150 select-none">
